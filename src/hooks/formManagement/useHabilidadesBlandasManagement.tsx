...
export interface HabilidadesBlandasFormFields {
  descripcion: string;
}

const defaultValues: HabilidadesBlandasFormFields = {
  descripcion: "",
};

export const useHabilidadesBlandasManagement = () => {
  ...
  const submit: SubmitHandler<HabilidadesBlandasFormFields> = async ({ descripcion }) => {
    MySwal.fire({
